...
<?php
    // watch recurrent targets for each month
    Target\Create::watchRecurrents();
?>
...
<script data-main="../builder/assets3/js/main-built.js" src="../builder/assets3/js/lib/require.js" ></script>
