...
<td>
<div id="exec">
<h2 align="center">VERIFICATION OF COMPANY ACCOUNTS FILE </h2><br />
<form method="post" action="process_verification_of_acct_file.php" name="staff_info_file" id="staff_info_file">
