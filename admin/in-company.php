...
<td>
<div id="exec">
<h2 align="center">IN-COMPANY SAFETY</h2><br />
...
<p class="ex" align="left">Target : &nbsp;&nbsp;<input class="only" type="text" size="25" name="target" id="target" /></p><br />
<p align="left" class="ex">No. of Survey Conducted : &nbsp;&nbsp;<input class="only" type="text" size="25" name="survey" id="survey" /></p><br />
<p align="left" class="ex">No. of Programme Implemented : &nbsp;&nbsp;<input class="only" type="text" size="25" name="prog_impl" id="prog_impl" /></p><br />
<p align="left" class="ex">No. of Participants : &nbsp;&nbsp;<input class="only" type="text" size="25" name="participant" id="participant" /></p><br />
<p align="left" class="ex">No. of Organizations : &nbsp;&nbsp;<input class="only" type="text" size="25" name="org" id="org" /></p><br />
...
<div align="center" id="style1"><p><span style="color:#F00; display:inline">&copy;</span> &#176 <?php echo date('Y'); ?>  &nbsp; &nbsp;<span style="color:#03C">Industrial Training Fund.</span> All Rights Reserved.</p></div>
