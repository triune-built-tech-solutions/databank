...
<div id="pag">
<p class=" btn btn-danger"><a href="view_legals.php">View Legal Reports</a></p>
</div>
<hr />

<div id="page">
<h2 align="center">LEGAL REPORT</h2><br />
<form method="post" action="addlegal_submit.php" name="scheduled" id="scheduled">
...
<p align="left" class="ex">Legal Retainer/Firm: &nbsp;&nbsp;<input class="only" type="text" size="25" name="retainer" id="participants" /></p><br />
<p align="left" class="ex">ITF Location: &nbsp;&nbsp;<input class="only" type="text" size="25" name="location" id="organization" /></p><br />
<p class="ex" align="left">Case/Suit Number : &nbsp;&nbsp;<input class="only" type="text" size="25" name="caseno" id="email" /></p><br />
<p class="ex" align="left">Status : &nbsp;&nbsp;<input class="only" type="text" size="25" name="status" id="address" /></p><br />
<p align="left" class="ex">Amount : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amount" id="phone" /></p><br />
<p align="left" class="ex">Remarks : &nbsp;&nbsp;<input class="only" type="text" size="25" name="remarks" id="phone" /></p><br />
<p align="center"><input type="submit" id="send" value="Add Legal" name="submit" class="btn btn-danger"/></p><br />
</form>
</div>
<p class="both" />
</div><!-- close content -->
