...
<table>
<tr>
  <th colspan="15">Legal Reports</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<td bgcolor="'.$bg_color.'">'.$retainer .'</td>
<td bgcolor="'.$bg_color.'">'.$location .'</td>
<td bgcolor="'.$bg_color.'">'.$case_number .'</td>
<td bgcolor="'.$bg_color.'">'.$status .'</td>
<td bgcolor="'.$bg_color.'">'.$amount .'</td>
<td bgcolor="'.$bg_color.'">'.$remarks .'</td>
...
<td bgcolor="'.$bg_color.'"><a href="each_leg.php?id='.$rep_id.'">Edit</a></td>
