...
<div id="pag">
&nbsp;&nbsp;&nbsp;&nbsp;
<p class="sid"><a href="view_itf_collaboration.php">View Trainee</a></p>
</div>
<div id="page">
<h2 align="center">ITF COLLABORATIONS' TRAINEE DETAIL</h2><br />
<form method="post" action="process_itf_collaboration.php" name="scheduled" id="scheduled">
...
<p align="left" class="ex">Training Title : &nbsp;&nbsp;<input class="only" type="text" size="25" name="train_title" id="train_title" /></p><br />
