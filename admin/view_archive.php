...
<form action="restore_staff.php" method="post" id="form_del">
<table>
<tr><th colspan="8">Staff Information Reports</th></tr>
<tr>
<th><input name="delete" value="Restore" type="submit" onClick="return confirm('Do you really want to Restore?');" /></th>
<th>S/n</th>
<th>Surname</th>
<th>Other Names</th>
<th>Staff No.</th>
...
for($i=0; $i<mysqli_num_rows($result_report_view); $i++){
	...
	<td bgcolor="'.$bg_color.'"> <a href="each_retired_staff_prog.php?repId='.$rep_id.'">View</a></td>
	</tr>';
