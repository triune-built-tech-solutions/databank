...
<form method="post" action="add_indepth.php" name="indepth" id="indepth">
...
<p align="left" class="ex">NO. of Studies carried out : &nbsp;&nbsp;<input class="only" type="text" size="25" name="std_c_o" id="std_c_o" /></p><br />
<p align="left" class="ex">Intervention Developed : &nbsp;&nbsp;<input class="only" type="text" size="25" name="int_dev" id="int_dev" /></p><br />
<p align="left" class="ex">Intervention implemented: &nbsp;&nbsp;<input class="only" type="text" size="25" name="int_imp" id="int_imp" /></p><br />
