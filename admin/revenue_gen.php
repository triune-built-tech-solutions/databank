...
<form method="post" action="add_revenue.php" name="rev_gen" id="rev_gen">
...
<p align="left" class="ex">Expected Revenue  : &nbsp;&nbsp;<input class="only" type="text" size="25" name="exp_rev" id="exp_rev" /></p><br />
<p align="left" class="ex">Amount Collected : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amt_coll" id="amt_coll" /></p><br />
<p align="left" class="ex">Amount Budgeted : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amt_budg" id="amt_budg" /></p><br />
<p class="ex" align="left">No. of Programme(s) implemented during the month : &nbsp;&nbsp;<input class="only" type="text" size="25" name="prog_imp" id="prog_imp" /></p><br />
<p align="left" class="ex">Net Revenue : &nbsp;&nbsp;<input class="only" type="text" size="25" name="net_rev" id="net_rev" /></p><br />
