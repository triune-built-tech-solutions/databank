...
<td>
<div id="exec">
<h2 align="center">Company Verified Details </h2><br />
<form method="post" action="process_comp_verd.php" name="scheduled" id="scheduled">
...
<p class="ex" align="left">Amount Liable : &nbsp;&nbsp;<input class="only" type="text" size="25" name="address" id="address" /></p><br />
<p align="left" class="ex">Variance Established : &nbsp;&nbsp;<input class="only" type="text" size="25" name="variance" id="variance" /></p><br />
<p align="left" class="ex">Amount Paid: &nbsp;&nbsp;<input class="only" type="text" size="25" name="amount" id="amount" /></p><br />
