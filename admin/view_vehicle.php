...
<tr>
<td colspan="1" align="left"> <a href="add_vehicle.php" class="btn btn-danger"> Add Vehicle </a></td>
<td colspan="11"></td>
  </tr>
  
  <tr>
  <th colspan="14">Legal Reports</th></tr>
<tr  style="background:#333; color:#FFF;"><td style="color:#FFF;">S/n</td>
<td style="color:#FFF;">Make of Vehicle</td>
<td style="color:#FFF;">Colour</td>
<td style="color:#FFF;">Chassis No</td>
<td style="color:#FFF;">Engine No</td>
<td style="color:#FFF;">Registration No</td>
<td style="color:#FFF;">Date Purchase</td>
<td style="color:#FFF;">Amount</td>
<td style="color:#FFF;">Location</td>
<td style="color:#FFF;">Uses</td>
...
<td><a href="#" id="<?php print $r['sn']; ?>" class="delbutton">Delete</a></td>
