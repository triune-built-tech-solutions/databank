...
<div id="content"><!-- open content -->
	...
	<div class="card shadow">
		<div class="card-header">
			<h4>Apprenticeship Company Details</h4>
		</div>
		<div id="exec" class="card-body ml-5">
			<form method="post" action="process_apprenticeship.php" name="scheduled" id="scheduled">
				...
				<br/>
				<p class="form-group form-inline">Name of Company: <input class="form-control ml-3" type="text" size="25" name="company" id="company"/></p>
				<br/>
				<p class="form-group form-inline">Address : <input class="form-control ml-3" type="text" size="25" name="address" id="address"/></p>
				<br/>
				<p class="form-group form-inline">Trade Area : <input class="form-control ml-3" type="text" size="25" name="trade_area" id="trade_area"/></p>
				<br/>
				<p class="form-group form-inline">No. of Participants: <input class="form-control ml-3" type="text" size="25" name="participant" id="participant"/></p>
				<br/>
