...
<form method="post" action="add_ind_based.php" name="ind_based" id="ind_based">
...
<p align="left" class="ex">NO. of Surveys carried out : &nbsp;&nbsp;<input class="only" type="text" size="25" name="surveys" id="surveys" /></p><br />
<p align="left" class="ex">Training Interview Implemented: &nbsp;&nbsp;<input class="only" type="text" size="25" name="training" id="training" /></p><br />
