...
<select class="only" id="off_loc" name="off_loc"><option value="<?php echo $office_location; ?>"> <?php echo $office_loc; ?></option></select></p><br />
...
<p align="left" class="ex">NO. of Surveys carried out : &nbsp;&nbsp;<input class="only" type="text" size="25" name="surv_c_o" id="surv_c_o" /></p><br />
<p align="left" class="ex">Training Intervention Developed : &nbsp;&nbsp;<input class="only" type="text" size="25" name="train_int_dev" id="train_int_dev" /></p><br />
<p align="left" class="ex">Training Intervention Implemented: &nbsp;&nbsp;<input class="only" type="text" size="25" name="train_int_imp" id="train_int_imp" /></p><br />
