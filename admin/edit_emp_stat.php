...
<?php
if($access_right == 4){
	$query_report_view = "select * from emp_stat order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'">'.$defaulting.'</td>
<td bgcolor="'.$bg_color.'">'.$month_row[1] .'</td>
<td bgcolor="'.$bg_color.'">'.$year .'</td>
<td bgcolor="'.$bg_color.'">'.$auto_date .'</td>
<td bgcolor="'.$bg_color.'"><a href="each_emp_stat.php?id='.$rep_id.'">Edit</a></td>
</tr>';
}
