...
<div id="data_show">
<form method="post" action="add_user.php" name="add_user" id="add_user">
...
<span id="un" class="notVisible"><span style='color:#1e69c7; font-size:13px; font-weight:bold;'>Unit</span> : <select id="unit" name="unit"><option value=" ">--Unit--</option>
<?php
...
<span id="s_un" class="notVisible"><span style='color:#1e69c7; font-size:13px; font-weight:bold;'>Sub-unit</span> : <select name="sub_unit" id="sub_unit">
