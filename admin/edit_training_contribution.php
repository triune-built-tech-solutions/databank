...
<?php
if($access_right == 4){
	$query_report_view = "select * from train_cont order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'">'.$total_t_date.'</td>
<td bgcolor="'.$bg_color.'">'.$month_row[1] .'</td>
<td bgcolor="'.$bg_color.'">'.$year .'</td>
<td bgcolor="'.$bg_color.'">'.$auto_date .'</td>
<td bgcolor="'.$bg_color.'"><a href="each_training_contribution.php?id='.$rep_id.'">Edit</a></td>
</tr>';
}
