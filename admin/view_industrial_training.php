...
<table>
<tr><th colspan="14">Apprenticeship Standardization and Evaluation</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<td bgcolor="'.$bg_color.'">'.$prom_visits.'</td>
<td bgcolor="'.$bg_color.'">'.$appraisal.'</td>
<td bgcolor="'.$bg_color.'">'.$install_harmonized.'</td>
<td bgcolor="'.$bg_color.'">'.$harmonized.'</td>
<td bgcolor="'.$bg_color.'">'.$monitored.'</td>
<td bgcolor="'.$bg_color.'">'.$prov_apprentice.'</td>
<td bgcolor="'.$bg_color.'">'.$full_apprentice.'</td>
