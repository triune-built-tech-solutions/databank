...
<table>
<tr><th colspan="15">Courses Approvals</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<?php
if($access_right == 4){
	$query_report_view = "select * from course_approvals order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'"><a href="each_course_approval.php?id='.$rep_id.'">Edit</a></td>
