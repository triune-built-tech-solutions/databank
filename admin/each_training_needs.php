...
<td>
<div id="exec">
<h2 align="center">TRAINING NEEDS ASSESSMENT</h2><br />
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="train_need" id="train_need">
...
<p class="ex" align="left">Target : &nbsp;&nbsp;<input class="only" type="text" size="25" name="target" id="target" value="<?php echo $tar ?>" /></p><br />
<p align="left" class="ex">NO. of Surveys carried out : &nbsp;&nbsp;<input class="only" type="text" size="25" name="surv_c_o" id="surv_c_o" value="<?php echo $suv ?>" /></p><br />
<p align="left" class="ex">Training Intervention Developed : &nbsp;&nbsp;<input class="only" type="text" size="25" name="train_int_dev" id="train_int_dev" value="<?php echo $dev ?>" /></p><br />
<p align="left" class="ex">Training Intervention Implemented: &nbsp;&nbsp;<input class="only" type="text" size="25" name="train_int_imp" id="train_int_imp" value="<?php echo $imp ?>" /></p><br />
...
?>
<script type="text/javascript" src="old_assets/val_train_need.js"></script>
</body>
</head>
</html>