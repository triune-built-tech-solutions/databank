...
if(isset($opt)){
	$query_part = "select * from itf_collaboration $opt order by name limit 80";
} else {
	$query_part = "select * from itf_collaboration order by name limit 80";
}
...
<table>
<tr><th colspan="13">ITF Collaboration Participant</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
