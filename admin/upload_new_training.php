...
<td>
<div id="exec">
<h2 align="center">NEW TRAINING PACKAGE DEVELOPED AND TEST-RUN FILE </h2><br />
<form method="post" action="process_new_training_file.php" name="staff_info_file" id="staff_info_file">
