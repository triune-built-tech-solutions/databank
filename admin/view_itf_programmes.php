...
<div id="content"><!-- open content -->
	...
	<div class="card shadow">
		<div class="card-header">
			<h4>ITF Training Programmes</h4>
		</div>
		<div class="card-body">
			<table class="table table-bordered table-hover table-responsive-md" id="dataTable" width="100%" cellspacing="0">
				<thead>
				<tr>
					<th>S/N</th>
					<th>Office Type</th>
					<th>Office Location</th>
					<th>Training Programme Title</th>
					<th>Training Programme Category</th>
					<th><span class="ex">Date Created</span></th>
					<th>Date Added</th>
				</tr>
				</thead>
