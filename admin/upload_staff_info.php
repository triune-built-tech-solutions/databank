...
<td>
<div id="exec">
<h2 align="center">STAFF INFORMATION FILE </h2><br />
<form method="post" action="process_staff_file.php" enctype="multipart/form-data" name="staff_info_file" id="staff_info_file">
