...
<?php
if($access_right == 4){
	$query_report_view = "select * from ver_comp_acct order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'">'.$comp_verd.'</td>
...
<td bgcolor="'.$bg_color.'"><a href="each_verification_of_acct.php?id='.$rep_id.'">Edit</a></td>
</tr>';
}
