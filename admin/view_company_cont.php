...
if(isset($opt)){
	$query_part = "select * from comp_cont_detail $opt order by name limit 80";
} else {
	$query_part = "select * from comp_cont_detail order by name limit 80";
}
...
for($i=0; $i<mysqli_num_rows($result_part); $i++){
	...
	$strength = mysqli_result($result_part,  $i,  "comp_strength");
...
<table>
<tr><th colspan="13">Company Contribution Details</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<td bgcolor="'.$bg_color.'">'.$strength.'</td>
