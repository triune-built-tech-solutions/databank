...
<div id="pag">
<p class=" btn btn-danger"><a href="view_meeting.php">View minutes</a></p>
</div>
<hr />

<div id="page">
<form method="post" action="add_meeting.php" enctype="multipart/form-data" id="meet">
...
<p class="ex" align="left">Meeting Title : <input class="only" type="text" size="40" name="heading" id="heading" /></p><br />
<p align="left" class="ex">Minute Of Meeting : &nbsp;&nbsp;<input class="only" type="file" name="m_file" /></p><br />
