...
<form method="post" action="add_other.php" name="other_inc" id="other_inc">
...
<p align="left" class="ex">Amount Generated for the month : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amt_gen" id="amt_gen" /></p><br />
