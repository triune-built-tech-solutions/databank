...
<div id="content"><!-- open content -->
	...
	<div class="card shadow">
		<div class="card-header">
			<h4>New Training Programme Proposal</h4>
		</div>
		<div class="card-body">
			<table class="table table-hover table-responsive">
				...
				<?php
				if ($access_right == 4) {
					$query_report_view = "select * from new_training order by year desc, month desc limit 80";
				} else {
...
<td >' . $year . '</td>
<td >' . $auto_date . '</td>
<td ><a href="each_new_training.php?id=' . $rep_id . '">Edit</a></td>
