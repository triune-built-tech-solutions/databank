...
<?php
if($access_right == 4){
	$query_report_view = "select * from outs_c_f_prev_y order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'"><a href="each_outstanding_course.php?id='.$rep_id.'">Edit</a></td>
</tr>';
}
