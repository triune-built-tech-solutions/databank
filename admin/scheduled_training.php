...
<td>
<div id="exec">
<h2 align="center">SCHEDULED TRAINING PROGRAMMES </h2><br />
...
<p align="left" class="ex">NO. Implemented For The Month: &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="implemented" id="implemented" /></p><br />
<p align="left" class="ex">NO. of Participants: &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="participants" id="participants" /></p><br />
<p align="left" class="ex">NO. of Organizations: &nbsp;&nbsp;<input class="only" type="text" size="25" name="organization" id="organization" /></p><br />
<p align="left" class="ex">Duration: &nbsp;&nbsp;<input class="only" type="text" size="25" name="duration" id="duration" /></p><br />
<p align="left" class="ex">Revenue from Course: &nbsp;&nbsp;<input class="only" type="text" size="25" name="rev_c" id="rev_c" /></p><br />
<p align="left" class="ex">Amount Collected: &nbsp;&nbsp;<input class="only" type="text" size="25" name="revenue" id="revenue" /></p><br />
<p align="left" class="ex">Amount Outstanding: &nbsp;&nbsp;<input class="only" type="text" size="25" name="rev_t" id="rev_t" /></p><br />
