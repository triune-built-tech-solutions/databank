...
?>
	...
	<div id="content"><!-- open content -->
		...
		<hr/>
		<div>
			<a class="btn btn-danger" href="view_nominal.php">View Nominal</a>
		</div>
		<hr>
		<div id="page">
			<?php
			...
			<form method="post" action="process_edit_prog.php" enctype="multipart/form-data" id="meet">
				...
				<p class="ex" align="left">Programme Type : &nbsp;&nbsp;&nbsp;&nbsp;
					<select class="only" name="prog_type" id="prog_type">
	...
	<option value="long term" selected="selected"> Long term </option>';
				...
				<p class="ex" align="left">Training Type : &nbsp;&nbsp;&nbsp;&nbsp;
					<select class="only" name="type" id="type">
	...
	<option value="CFE" selected> Centre CFE Trainings </option>';
				...
				<br/>
				<p class="ex input-group" align="left">Training Title : <input class="form-control" type="text" size="40" name="title" id="title" value="<?php echo $title; ?>"/></p><br/>
				<p class="ex input-group" align="left">Start Date : <input class="form-control" type="text" size="40" name="t_date" id="t_date" value="<?php echo $sex; ?>"/></p><br/>
				<p class="ex input-group" align="left">Finish Date : <input class="form-control" type="text" size="40" name="t_date_f" id="t_date_f" value="<?php echo $finish_date; ?>"/></p>
				<br/>
				<p class="ex input-group" align="left">Location : <input class="form-control" type="text" size="40" name="location" id="location" value="<?php echo $date_appt ?>"/></p><br/>
				<input type="text" name="nom_id" id="nom_id" value="<?php echo $rep_id; ?>" class="not_visible"/>
				<p align="center"><button class="btn btn-success" type="submit" id="send" value="Submit" name="submit">Submit</button>
			</form>
		</div>
		<p class="both"/>
	</div><!-- close content -->
