...
<td>
<div id="exec">
<h2 align="center">INDUSTRIAL TRAINING AND DEVELOPMENT PROGRAMME </h2><br />
...
<p class="ex" align="left">No. of Promotional visits : &nbsp;&nbsp;<input class="only" type="text" size="25" name="prom_vis" id="prom_vis" value="<?php echo $prom ?>" /></p><br />
<p align="left" class="ex">No. of Appraisal : &nbsp;&nbsp;<input class="only" type="text" size="25" name="appraisal" id="appraisal" value="<?php echo $appr ?>" /></p><br />
<p align="left" class="ex">No. of installed/Harmonized : &nbsp;&nbsp;<input class="only" type="text" size="25" name="inst_harm" id="inst_harm" value="<?php echo $inst ?>" /></p><br />
<p align="left" class="ex">No. Monitured: &nbsp;&nbsp;<input class="only" type="text" size="25" name="monitored" id="monitored" value="<?php echo $moni ?>" /></p><br />
