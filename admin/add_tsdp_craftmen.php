...
<td>
<div id="exec">
<h2 align="center"> TSDP MASTERCRAFTMEN/CENTER DETAILS </h2><br />
<form method="post" action="process_tsdp_craftmen.php" name="nisdp_craftmen" id="nisdp_craftmen">
...
<p align="left" class="ex">Name of Centre: &nbsp;&nbsp;<input class="only" type="text" size="25" name="centre" id="centre" /></p><br />
<p align="left" class="ex">Name of Centre Coordinator: &nbsp;&nbsp;<input class="only" type="text" size="25" name="craftman" id="craftman" /></p><br />
<p align="left" class="ex">Coordinator's Phone Number : &nbsp;&nbsp;<input class="only" type="text" size="25" name="phone" id="phone" /></p><br />
