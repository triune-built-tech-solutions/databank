...
if(isset($_POST['submit'])){
	...
	$added_by = $user_name;
		...
		$staff_info = "INSERT INTO nisdp_part VALUES (null, $off_type, $off_loc, $rep_month, '$rep_year', '$participants', '$organization', '$gender', '$email', '$address', '$phone', '$train_center', '$qual', '$enrol', '$grad', '$show_date', '$added_by')";
