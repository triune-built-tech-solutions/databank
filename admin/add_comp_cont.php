...
<td>
<div id="exec">
<h2 align="center">Training Contribution Company Details </h2><br />
<form method="post" action="process_comp_cont.php" name="scheduled" id="scheduled">
...
<p class="ex" align="left">ITF National  No. : &nbsp;&nbsp;
...
<p align="left" class="ex">Email : &nbsp;&nbsp;<input class="only" type="text" size="25" name="email" id="email" /></p><br />
...
<p align="left" class="ex">No. of Employees (Nigerian): &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="strength" id="strength" /></p><br />
<p class="ex" align="left">No. of Employees (Non-Nigerian) : &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="reg_no" id="reg_no" /></p><br />
  <p class="ex" align="left">Amount Paid: &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="reg_no" id="reg_no" /></p><br />
  <p class="ex" align="left">Date of Verification: &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="reg_no" id="reg_no" /></p><br />
<!--input type="text" name="verd_id" id="verd_id" class="not_visible" value="?php echo $taker; ?>" -->
