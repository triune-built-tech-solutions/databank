...
<div id="content"><!-- open content -->
	...
	<div class="card shadow">
		<div class="card-header">
			<h4>In-Company Participant's Details</h4>
		</div>
		<div id="exec" class="card-body">
			<form method="post" action="process_in_comp_part.php" name="scheduled" id="scheduled">
				...
				<br/>
				<p class="form-group form-inline">Name of Participant: <input class="form-control ml-3" type="text"
							size="25" name="participants" id="participants"/></p>
				<br/>
				<p class="form-group form-inline">Gender :<select class="form-control ml-3" id="gender" name="gender">
				...
				<br/>
				<p class="form-group form-inline">Phone Number :<input class="form-control ml-3" type="text" size="25"
