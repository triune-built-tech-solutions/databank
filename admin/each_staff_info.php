...
<p class="ex" align="left">NO. of Senior Staff : &nbsp;&nbsp;<input class="only" type="text" size="25" name="sen_staff" id="sen_staff" value="<?php echo $sen; ?>" /></p><br />
<p align="left" class="ex">NO. of Junior Staff : &nbsp;&nbsp;<input class="only" type="text" size="25" name="jun_staff" id="jun_staff" value="<?php echo $jun; ?>" /></p><br />
<p align="left" class="ex">Other Non-Staff (IT NYSC etc) : &nbsp;&nbsp;<input class="only" type="text" size="25" name="oth_staff" id="oth_staff" value="<?php echo $non; ?>" /></p><br />
<p align="left" class="ex">Staff disciplinary action during the month : &nbsp;&nbsp;<input class="only" type="text" size="25" name="staff_dis" id="staff_dis" value="<?php echo $dis; ?>" /></p><br />
