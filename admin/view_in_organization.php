...
<table>
<tr><th colspan="12">In-Company Safety Organizations</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
$query_report_view = "select * from incompany where id = '".$taker."' order by year desc, month desc limit 80";
...
$query_part = "select * from in_comp_org where office_type = ".$office_type." and office_loc = ".$office_location." and month = ".$month." and year = ".$year." order by name limit 80";
