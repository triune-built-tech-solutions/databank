...
<p class="ex" align="left">NO. of Participating institutions : &nbsp;&nbsp;<input class="only" type="text" size="25" name="part_inst" id="part_inst" /></p><br />
<p align="left" class="ex">NO. of Orientations during the month : &nbsp;&nbsp;<input class="only" type="text" size="25" name="orien_d_month" id="orien_d_month" /></p><br />
<p align="left" class="ex">NO. of Zonal Meetings : &nbsp;&nbsp;<input class="only" type="text" size="25" name="zonal_meet" id="zonal_meet" /></p><br />
<p align="left" class="ex">NO. of Students placed : &nbsp;&nbsp;<input class="only" type="text" size="25" name="std_plc_d_m" id="std_plc_d_m" /></p><br />
<p align="left" class="ex">NO. of Students Eligible for payment : &nbsp;&nbsp;<input class="only" type="text" size="25" name="std_eligable" id="std_eligable" /></p><br />
<p align="left" class="ex">NO. of Students paid : &nbsp;&nbsp;<input class="only" type="text" size="25" name="std_paid" id="std_paid" /></p><br />
<p align="left" class="ex">Amount paid : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amt_paid" id="amt_paid" /></p><br />
<p align="left" class="ex">Amount Outstanding : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amt_paid" id="amt_paid" /></p><br />
<p align="left" class="ex">Supervisory Allowance paid : &nbsp;&nbsp;<input class="only" type="text" size="25" name="sup_all_p" id="sup_all_p" /></p><br />
<p align="left" class="ex">Supervisory Allowance Outstanding : &nbsp;&nbsp;<input class="only" type="text" size="25" name="sup_all_p" id="sup_all_p" /></p><br />
