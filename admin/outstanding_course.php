...
<td>
<div id="exec">
<h2 align="center">OUTSTANDING COURSE FEE
</h2><br />
<form method="post" action="add_outstand.php" name="outs_cour" id="outs_cour">
...
<p class="ex" align="left">Total Amount Outstanding: &nbsp;&nbsp;<input class="only" type="text" size="25" name="gross_amt" id="gross_amt" /></p><br />
