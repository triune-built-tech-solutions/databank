...
<select name="gender"><option value=" ">-Gender-</option>
...
<form action="del_nominal.php" method="post" id="form_del">
<table>
<tr><th colspan="8">Staff Information Reports</th></tr>
<tr>
<th><input name="delete" value="Delete" type="submit" onClick="return confirm('User detail will be sent to archive?');" /></th>
<th>S/n</th>
<th>Surname</th>
<th>Other Names</th>
<th>Staff No.</th>
...
for($i=0; $i<mysqli_num_rows($result_report_view); $i++){
	...
	<td bgcolor="'.$bg_color.'"><a href="edit_nominal.php?repId='.$rep_id.'">'.$ij .'</a></td>
	<td bgcolor="'.$bg_color.'">'.$surname .'</td>
	<td bgcolor="'.$bg_color.'">'.$other_name .'</td>
	<td bgcolor="'.$bg_color.'">'.$staff_no.'</td>
	<td bgcolor="'.$bg_color.'">'.$sex .'</td>
	<td bgcolor="'.$bg_color.'"> <a href="add_staff_prog.php?repId='.$rep_id.'">Add</a></td>
	<td bgcolor="'.$bg_color.'"> <a href="each_staff_prog.php?repId='.$rep_id.'">View</a></td>
	</tr>';
