...
if(isset($_POST['submit'])){
	...
	$exist = "SELECT * from industrial_based where office_location = ".$off_loc." AND month = ".$rep_month." AND year = '".$rep_year."'";
	...
	if($row_exist == 0){
		$staff_info = "INSERT INTO industrial_based VALUES (null, $off_type, $off_loc, $rep_month, '$rep_year', '$show_date', '$added_by', $target, $surveys, $training)";
	
		mysqli_query( $connect, $staff_info) or
		die("Error connecting to server ".mysqli_error($GLOBALS["___mysqli_ston"]));
		header("Location: industrial_based.php");
	} else {
		header("Location: view_industrial_based.php?err=exist");
	}
}
?>