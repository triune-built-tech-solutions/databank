...
<p align="left" class="ex">No. of Packages developed : &nbsp;&nbsp;<input class="only" type="text" size="25" name="packages_dev" id="packages_dev" /></p><br />
<p align="left" class="ex">No. Implemented: &nbsp;&nbsp;<input class="only" type="text" size="25" name="implemented" id="implemented" /></p><br />
<p align="left" class="ex">No. of Participants: &nbsp;&nbsp;<input class="only" type="text" size="25" name="participants" id="participants" /></p><br />
<p align="left" class="ex">Amount Collected: &nbsp;&nbsp;<input class="only" type="text" size="25" name="participants" id="participants" /></p><br />
<p align="left" class="ex">Amount Outstanding: &nbsp;&nbsp;<input class="only" type="text" size="25" name="participants" id="participants" /></p><br />
