...
<div id="content"><!-- open content -->
	...
	<div id="page" class="card shadow mb-5">
		...
		<form class="card-body" method="post" action="process_edit_nominal.php" enctype="multipart/form-data" id="meet">
			<p class="ex input-group" align="left">Surname : <input class="form-control" type="text" size="40" name="surname" id="surname" value="<?php echo $surname; ?>"/></p><br/>
			<p class="ex input-group" align="left">Other Names: <input class="form-control" type="text" size="40" name="other_name" id="other_name" value="<?php echo $other_name; ?>"/></p><br/>
			<p class="ex input-group" align="left">Staff Number : <input class="form-control" type="text" size="40" name="staff_no" id="staff_no" value="<?php echo $staff_no; ?>"/></p><br/>
	...
	<option value="M"> Male </option>';
			...
			<br/>
			<p class="ex input-group" align="left">Job Title : <input class="form-control" type="text" size="40" name="job_title" id="job_title" value="<?php echo $job_title; ?>"/></p><br/>
			<p class="ex input-group" align="left">Date of first Appt : <input class="form-control" type="text" size="40" name="doa" id="doa" value="<?php echo $date_appt; ?>"/></p><br/>
			<p class="ex input-group" align="left">Date of Birth : <input class="form-control" type="text" size="40" name="dob" id="dob"
			                                                  value="<?php echo $dob; ?>"/></p><br/>
			...
			<br/>
			<input class="only not_visible" type="text" size="40" name="repid" id="repid"
			       value="<?php echo $_GET['repId']; ?>"/>
			<p align="center"><button class="btn btn-success" type="submit" id="send" value="Edit" name="submit">Submit</button></p><br/>
		</form>
	</div>
	<p class="both"/>
</div><!-- close content -->
