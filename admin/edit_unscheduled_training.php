...
<table>
<tr><th colspan="13">Unscheduled Training Programmes</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<?php
if($access_right == 4){
	$query_report_view = "select * from unscheduled_training order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'"><a href="each_unscheduled_training.php?id='.$rep_id.'">Edit</a></td>
