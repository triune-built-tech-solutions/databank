		...
		<div class="card shadow">
			...
			<div class="card-body">
				<div id="exec">
					...
					<form class="row" method="post" action="add_staff_info.php" id="staff_inf">
	...
	<select class="only"  name="off_loc" id="office_loc">
						...
						<div class="col-md-6">
							<div class="form-group form-inline" align="left">
								...
								<input class="form-control ml-3" type="text" name="sen_staff" id="sen_staff"/>
							</div>
							<div class="form-inline form-group">
								<label for="">NO. of Junior Staff :</label>&nbsp;&nbsp;
								<input class="form-control ml-3" type="text" name="jun_staff" id="jun_staff"/>
							</div>
							<div class="form-group form-inline ">
								<label for="">Other Non-Staff (IT NYSC etc) :</label>
								<input class="form-control ml-3" type="text" size="25" name="oth_staff" id="oth_staff"/>
							</div>
							<div align="left" class="form-group form-inline">
								<label for="">Staff disciplinary action during the month :</label>&nbsp;&nbsp;
								<textarea class="form-control ml-3" type="text" name="staff_dis" id="staff_dis"></textarea>
							</div>
						</div>
						<div class="d-flex justify-content-center col-md-12">
							<button class="btn-primary btn" type="submit" id="send" value="Submit" name="submit">Submit</button>
						</div>
					</form>
				</div>
			</div>
