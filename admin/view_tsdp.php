...
<table>
<tr><th colspan="13">TSDP Participant</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
if(isset($opt)){
	$query_part = "select * from tsdp_part $opt order by name limit 80";
} else {
	$query_part = "select * from tsdp_part order by name limit 80";
}
