...
<table>
<tr><th colspan="15">In-Company Safety Participant</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
$query_part = "select * from in_comp_part where office_type = ".$office_type." and office_loc = ".$office_location." and month = ".$month." and year = ".$year." order by name limit 80";
