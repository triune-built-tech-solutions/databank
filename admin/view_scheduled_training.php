...
<table>
<tr><th colspan="11">Scheduled Training Programmes</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<td bgcolor="'.$bg_color.'">'.$training.'</td>
<td bgcolor="'.$bg_color.'">'.$implemented.'</td>
<td bgcolor="'.$bg_color.'"><a href="add_scheduled_part.php?id='.$rep_id.'">'.$participants.'</a></td>
<td bgcolor="'.$bg_color.'">'.$organization.'</td>
<td bgcolor="'.$bg_color.'">'.$rev_f_c.'</td>
<td bgcolor="'.$bg_color.'">'.$duration.'</td>
