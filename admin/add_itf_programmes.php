...
<br>
<div id="pag">
<p class=" btn btn-danger"><a href="view_itf_programmes.php">View List of ITF Training Programmes</a></p>
</div>
<hr />

<div id="page">
<h2 align="center">ITF TRAINING PROGRAMMES</h2><br />
...
<p align="left" class="ex">Training Programme Title: &nbsp;&nbsp;
...
<p align="left" class="ex">Training Programme Category: &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="organization" id="organization" /></p><br />
<p class="ex" align="left">Date Created : &nbsp;&nbsp;
  <input class="only" type="text" size="25" name="email" id="email" /></p><br />
