...
<div id="content"><!-- open content -->
	...
	<br>
	<div>
		<a class=" btn btn-danger" href="view_itf_programmes.php">View All ITF Training Programmes</a>
	</div>
	<hr/>

	<div id="page" class="card shadow">
		<div class="card-header">
			<h4>Create ITF Training Programme</h4>
		</div>
		<form class="card-body" method="post" action="process_nisdp_part.php" name="scheduled" id="scheduled">
			...
			<br/>
			<p align="left" class="">Training Programme Title:
				<input class="form-control m-0" type="text" name="participants" id="participants"/></p><br/>
			<p align="left" class="ex">Training Programme Category:
				<input class="form-control m-0" type="text" name="organization" id="organization"/></p><br/>
			<p class="ex" align="left">Date Created :
				<input class="form-control m-0" type="text" name="email" id="email"/></p><br/>
			<p align="center">
				<button class="btn btn-success" type="submit" id="send" value="Submit" name="submit">Create Programme</button><br/>
		</form>
	</div>
	<p class="both"/>
</div><!-- close content -->
