...
<form method="post" action="add_contribution.php" name="train_cont" id="train_cont">
...
<p align="left" class="ex">Amount Collected for the month : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amt_coll" id="amt_coll" /></p><br />
<!--p align="left" class="ex">Total Amounth Collected to date	 : &nbsp;&nbsp;<input class="only" type="text" size="25" name="total_amt_coll" id="total_amt_coll" /></p><br / -->
