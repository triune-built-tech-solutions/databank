...
<td>
<div id="exec">
<h2 align="center">OUTSTANDING COURSE FEE FROM PREVIOUS YEARS FILE </h2><br />
<form method="post" action="process_outstanding_course_file.php" name="staff_info_file" id="staff_info_file">
...
<p align="left" class="ex">Report File: &nbsp;&nbsp;<input class="only" type="file" size="25" name="report_file" id="report_file" /></p><br />
