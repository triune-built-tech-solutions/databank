...
<td>
<div id="exec">
<h2 align="center">Outstanding Course fee Company Details</h2><br />
<form method="post" action="process_comp_outstanding.php" name="scheduled" id="scheduled">
...
<p align="left" class="ex">Payment for : &nbsp;&nbsp;<select class="only" name="payment_year" id="payment_year"><option value=" ">-Year-</option>
<?php
$query_eyear = "Select * from eyear";
$result_eyear = mysqli_query( $connect, $query_eyear);
...
<p align="left" class="ex">Amount Due : &nbsp;&nbsp;<input class="only" type="text" size="25" name="amount_due" id="amount_due" /></p><br />
