...
<table>
<tr><th colspan="9">View all reports</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
<?php
if(isset($opt)){
	$query_report_view = "select * from report_log group by month, year, office_location order by year desc, month desc, prog_no, sub_prog_no, obj_no limit 40";
}else {
	$query_report_view = "select * from report_log group by month, year, office_location order by year desc, month desc, prog_no, sub_prog_no, obj_no limit 40";
}
...
<div align="center" id="style1"><span style="color:#F00">&copy;</span> &#176 2008-2013  &nbsp; &nbsp;<span style="color:#03C">Industrial Training Fund.</span> All Rights Reserved.</div>
