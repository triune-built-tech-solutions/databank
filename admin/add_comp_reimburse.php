...
<td>
<div id="exec">
<h2 align="center">Reimbursement Company Details </h2><br />
<form method="post" action="process_comp_reimburse.php" name="scheduled" id="scheduled">
...
<p class="ex" align="left">Reg. No. : &nbsp;&nbsp;<input class="only" type="text" size="25" name="reg_no" id="reg_no" /></p><br />
<p class="ex" align="left">Address : &nbsp;&nbsp;<input class="only" type="text" size="25" name="address" id="address" /></p><br />
<p class="ex" align="left">Company Type : &nbsp;&nbsp;&nbsp;&nbsp;
<select class="only" name="comp_type" id="comp_type"><option value=" ">-Company Type-</option>
