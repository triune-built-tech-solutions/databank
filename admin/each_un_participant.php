...
<table>
<tr><th colspan="20">Unscheduled Training Participant</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
$query_report_view = "select * from unscheduled_training where id = '".$taker."' order by year desc, month desc limit 80";
...
//echo "$added_by1";
$query_part = "select * from unscheduled_part WHERE added_by = '$added_by1' order by name limit 80";
...
<td bgcolor="'.$bg_color.'"><a href="each_unpart.php?repId='.$rep_id .'">View</a></td>
