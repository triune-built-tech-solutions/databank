...
<p align="left" class="ex">Name of Company: &nbsp;&nbsp;<input class="only" type="text" size="25" name="company" id="company" /></p><br />
...
<p class="ex" align="left">Email : &nbsp;&nbsp;<input class="only" type="text" size="25" name="email" id="email" /></p><br />
<p class="ex" align="left">Phone Number : &nbsp;&nbsp;<input class="only" type="text" size="25" name="phone" id="phone" /></p><br />
<p class="ex" align="left">Sector : &nbsp;&nbsp;<input class="only" type="text" size="25" name="sector" id="sector" /></p><br />
<p class="ex" align="left">No. of Employee : &nbsp;&nbsp;<input class="only" type="text" size="25" name="noemp" id="noemp" /></p><br />
