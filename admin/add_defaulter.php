...
<div id="content"><!-- open content -->
	...
	<table>
		<tr>
			...
			<td>
				<div id="exec">
					<h2 align="center">Defaulting Company Detail </h2><br/>
					<form method="post" action="process_defaulter.php" name="scheduled" id="scheduled">
						...
						<br/>
						<p align="left" class="ex">Name of Company: &nbsp;&nbsp;<input class="only" type="text"
						                                                               size="25" name="company"
						                                                               id="company"/></p><br/>
						<p class="ex" align="left">RC. No. : &nbsp;&nbsp;
							<input class="only" type="text" size="25" name="reg_no" id="reg_no"/></p><br/>
						<p class="ex" align="left">Address : &nbsp;&nbsp;<input class="only" type="text" size="25"
						                                                        name="address" id="address"/></p><br/>
						<p class="ex" align="left">Email : &nbsp;&nbsp;<input class="only" type="text" size="25"
						                                                      name="email" id="email"/></p><br/>
						<p class="ex" align="left">Phone Number : &nbsp;&nbsp;<input class="only" type="text" size="25"
						                                                             name="phone" id="phone"/></p><br/>
						<p class="ex" align="left">Sector : &nbsp;&nbsp;<input class="only" type="text" size="25"
						                                                       name="sector" id="sector"/></p><br/>
						<p class="ex" align="left">No. of Employee : &nbsp;&nbsp;<input class="only" type="text"
						                                                                size="25" name="noemp"
						                                                                id="noemp"/></p><br/>
						<p align="left" class="ex">Status : &nbsp;&nbsp;<select name="statu" id="statu" class="only">
								<option value=" ">--Status--</option>
								<option value="newly registered">Newly Registered</option>
								<option value="up to date">Up to Date</option>
								<option value="ordinary defaulter">Ordinary Defaulter</option>
								<option value="chronic defaulter">Chronic Defaulter</option>
							</select></p>
						<br/>
