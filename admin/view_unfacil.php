...
<table>
<tr><th colspan="15">Unscheduled Training Facilitator</th></tr>
<tr><th>S/n</th>
<th>Office Type</th>
...
//echo "$added_by1";
$query_part = "select * from unscheduled_facil WHERE added_by = '$added_by1' order by name limit 80";
...
for($i=0; $i<mysqli_num_rows($result_part); $i++){
	...
	$topic = mysqli_result($result_part,  $i,  "topic");
