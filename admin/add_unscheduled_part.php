...
if(isset($_GET['id'])){
	$user = $_GET['id'];
$sqlUp = "SELECT * FROM unscheduled_training WHERE id='$user'";
...
<td>
    ...
    <div class="panel panel-default">
        <div class="panel-heading2">
        	   <a href="down.php?m=1">Download Excel Template</a>
      
      </div>
      <div class="panel-heading">
        	  
          
            <a href="javascript:void(0);" onclick="$('#importFrm').slideToggle();">Import Participant's List</a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="exec">
<h2 align="center"> PARTICIPANT'S DETAIL </h2><br />

<form method="post" action="process_unscheduled_part.php" name="scheduled" id="scheduled">
...
<p align="left" class="ex">Programme title: &nbsp;&nbsp;<input class="only" type="text" size="25" name="prog" id="prog" value=" <?php echo $prog; ?>" readonly="readonly"/></p><br />
<p align="left" class="ex">Name of Organization: &nbsp;&nbsp;<input class="only" type="text" size="25" name="organization" id="organization" /></p><br />
<p align="left" class="ex">Sector : &nbsp;&nbsp;<input class="only" type="text" size="25" name="sector" id="sector" /></p><br />
<p align="left" class="ex">Name of Participant: &nbsp;&nbsp;<input class="only" type="text" size="25" name="participants" id="participants" /></p><br />
...
<p align="left" class="ex">Designation : &nbsp;&nbsp;<input class="only" type="text" size="25" name="designation" id="designation" /></p><br />
