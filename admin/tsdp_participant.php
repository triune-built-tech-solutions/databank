...
<div id="pag">
&nbsp;&nbsp;&nbsp;&nbsp;
<p class="sid"><a href="view_tsdp.php">View Participant</a></p>
</div>
<div id="page">
<h2 align="center">TSDP TRAINEES </h2><br />
<form method="post" action="process_tsdp_part.php" name="scheduled" id="scheduled">
