...
<td>
<div id="exec">
<h2 align="center"> ITF COLLABORATORS DETAIL </h2><br />
<form method="post" action="process_collaborator.php" name="collaborator" id="collaborator">
...
<p align="left" class="ex">Period of Collaboration: &nbsp;&nbsp;<input class="only" type="text" size="25" name="coll_period" id="coll_period" /></p><br />
<p align="left" class="ex">Objective of Collaboration: &nbsp;&nbsp;<input class="only" type="text" size="25" name="coll_period" id="coll_period" /></p><br />
<p align="left" class="ex">Area of Collaboration: &nbsp;&nbsp;<input class="only" type="text" size="25" name="coll_area" id="coll_area" /></p><br />
<p align="left" class="ex">Name of Contact Person: &nbsp;&nbsp;<input class="only" type="text" size="25" name="contact_person" id="contact_person" /></p><br />
