...
<?php
if($access_right == 4){
	$query_report_view = "select * from industrial_based order by year desc, month desc limit 80";
} else {
...
<td bgcolor="'.$bg_color.'"><a href="each_industrial_based.php?id='.$rep_id.'">Edit</a></td>
</tr>';
}
