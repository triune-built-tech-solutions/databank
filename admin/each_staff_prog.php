...
list($pas)=mysqli_fetch_row($qr);

?>
<img src="<?php print $pas ?>" alt="<?php print $id ?>" width="180" height="180" class="img-rounded">
...
?>
<a href="add_staff_prog.php?repId=<?php print $_GET['repId'] ?>" class="btn btn-danger"> Add Training </a>
