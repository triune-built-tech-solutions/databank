...
<div id="content"><!-- open content -->
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		<div class="form-group form-inline d-flex justify-content-center">
			...
			<a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="ml-3 ">Show All</a>
		</div>
	</form>
		...
		<div class="card-body">
			<table class="table table-bordered table-hover table-striped table-responsive" id="dataTable" width="100%" cellspacing="0">
				...
				<tr>
					...
					<th>Added by</th>
					<th>Date added</th>
					<th colspan="3" align="center`">Edit</th>
				</tr>
				</thead>
...
<td>' . $added_by . '</td>
<td>' . $date_added . '</td>
<td> <a href="account_manage.php?id=' . $id . '">Manage</a></td>
<td> <a href="reset_password.php?reset='.$id.'">Reset Password</a></td>
<td>' . $freeze . '</td>
</tr>';
				}
