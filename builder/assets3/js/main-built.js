...
function() {
    ...
    function() {
        ...
        return '<!-- Password input-->\n<div class="form-group">\n  <label class="col-md-4 control-label" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-md-4" <%}else { %> "<%= inputsize %>"<%}%> >\n    <input id="<%= id %>" name="<%= id %>" type="password" placeholder="<%= placeholder %>" class="form-control input-md" <% if(required) {%> required <% } %> />\n    <% if (helptext.length > 0) { %><span class="help-block"><%= helptext %></span><% } %>\n  </div>\n</div>\n'
    }), define("text!templates/snippet/numberinput.html", [], function() {
        return '<!-- Number input-->\n<div class="form-group">\n  <label class="col-md-4 control-label" for="<%= id %>"><%= label %></label>\n  <div class=<% if ( inputsize.length <= 0){ %>  "col-md-4" <%}else { %> "<%= inputsize %>"<%}%> >\n    <input id="<%= id %>" name="<%= id %>" type="number" placeholder="<%= placeholder %>" class="form-control input-md" <% if(required) {%> required <% } %> />\n    <% if (helptext.length > 0) { %><span class="help-block"><%= helptext %></span><% } %>\n  </div>\n</div>\n'
        ...
        var t = e("text!templates/snippet/formname.html"),
            ...
            i = e("text!templates/snippet/textinput.html"),
            inx = e("text!templates/snippet/numberinput.html");
        return {
            formname: t,
            prependedtext: n,
            search: r,
...
}), define("app/app", ["jquery", "underscore", "backbone", "collections/snippets", "collections/my-form-snippets", "views/tab", "views/my-form", "text!data/input.json", "text!data/radio.json", "text!data/select.json", "text!data/buttons.json"], function(e, t, n, r, i, s, o, u, a, f, l, c, h) {
    return {
        initialize: function() {
            new s({
                title: "Input",
